...
class TrajectoryBuilderInterface {
 public:
  ...
  virtual void SetLocalizationScore(const float localization_score, const bool pause_optimization_sign, const float global_pose_x, const float global_pose_y) = 0;
};
