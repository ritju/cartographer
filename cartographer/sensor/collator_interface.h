...
class CollatorInterface {
 public:
  ...
  virtual void SetLocalizationScore(float localization_score, std::vector<float> corrected_submap_pose, const float global_pose_x, const float global_pose_y) = 0;
